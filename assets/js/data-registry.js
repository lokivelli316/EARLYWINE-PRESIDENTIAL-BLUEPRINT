(function(){
  const routes = [
    ...
    {id:'blueprint',label:'Blueprint',href:null,state:'STAGED',kind:'architecture',desc:'Ten pillars as a connected systems architecture.'},
    {id:'explore',label:'Explore',href:null,state:'STAGED',kind:'interactive',desc:'AEGIS, Road Builder, Pillar, Weld, and white-paper explorers.'},
    {id:'papers',label:'White Papers',href:null,state:'SOURCE PACK PENDING',kind:'publication',desc:'Public paper family with source/package gates visible.'},
    {id:'research',label:'Research',href:null,state:'STAGED',kind:'evidence',desc:'Independent audits, datasets, Gate Closing, and research lineage.'},
    {id:'labs',label:'Labs',href:null,state:'EXPERIMENTAL',kind:'lab',desc:'Interactive tools, models, and staged experimental systems.'},
    {id:'receipts',label:'Receipts',href:null,state:'STAGED',kind:'integrity',desc:'Provenance, source integrity, correction lineage, and publication gates.'},
    {id:'rights',label:'Rights After Conviction',href:'prototype/voting_rights_explorer_v2.html',state:'REVIEW',kind:'rights',desc:'Federal baseline plus 50-state/DC rights navigator with dated source states.'},
    {id:'address',label:'Presidential Address',href:null,state:'STAGED',kind:'media',desc:'Five-track address, segmented media, and high-risk systems annex.'},
