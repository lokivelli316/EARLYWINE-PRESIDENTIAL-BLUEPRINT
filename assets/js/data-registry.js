(function(){
  const routes = [
    ...
    {id:'receipts',label:'Receipts / Source Integrity',href:'source-integrity-build/source-integrity-preview.html',state:'LIVE',kind:'integrity',desc:'Provenance, source integrity, correction lineage, and publication gates.'},
    {id:'rights',label:'Know Your Rights',href:'rights-build/know-your-rights.html',state:'LIVE',kind:'rights',desc:'Standalone Quiet Evidence Room for rights-after-conviction verification with federal/state distinction preserved.'},
